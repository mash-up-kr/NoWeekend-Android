...
object NWKDrawableResource {
    /* Icon */
    val CalendarOff: Int = R.drawable.icn_calendar_off
    val CalendarOn: Int = R.drawable.icn_calendar_on
    val HomeOff: Int = R.drawable.icn_home_off
    ...
    val Home: Int = R.drawable.img_home
    val Korea: Int = R.drawable.img_korea
    val Sandwich: Int = R.drawable.img_sandwich
    ...
    val ToasterDefault: Int = R.drawable.img_toaster_default

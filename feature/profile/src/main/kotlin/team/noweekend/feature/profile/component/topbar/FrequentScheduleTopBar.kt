...
import team.noweekend.core.resource.NWKStringResource.ProfileFrequentScheduleTitle
...
@Composable
internal fun FrequentScheduleTopBar(
        ...
        components = arrayOf(
            ...
            { componentModifier ->
                Text(
                    ...
                    text = stringResource(id = ProfileFrequentScheduleTitle),
...
@Preview
@Composable
private fun PreviewFrequentScheduleTopBar() {
    NWKTheme {

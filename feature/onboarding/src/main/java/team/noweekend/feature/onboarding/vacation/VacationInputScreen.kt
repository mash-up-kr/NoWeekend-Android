package team.noweekend.feature.onboarding.vacation
    ...
    NWKScaffold(
        ...
        topBar = {
            NWKHeader(
                ...
                title = "2/3", // TODO : Replace with actual title
...
private fun RemainingVacationInputContainer(
    ...
    Row(
        ...
        NWKInputField(
            ...
            textHint = stringResource(NWKStringResource.DefaultDayNumber),
            isSingLine = true,
...
@Preview
@Composable
private fun VacationInputScreenPreview() {
    NWKTheme {
        VacationInputScreen(
            onClickBack = { /* Do nothing */ },
            onClickConfirm = { /* Do nothing */ },
            modifier = Modifier.fillMaxSize(),
        )
    }
}
